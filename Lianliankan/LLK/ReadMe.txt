================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : LLK Project Overview
===============================================================================

The application wizard has created this LLK application for
...
LLKDlg.h, LLKDlg.cpp - the dialog
    ...
    in LLK.rc, which can be edited in Microsoft Visual C++.
